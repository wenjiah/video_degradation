# python run_answer_quality_max.py --obj_name car --base_name night-street \
...
from Estimation.samplers_max import *
...
def estimate_max_error(obj_name, base_name, test_date, ground_truth, predictions, sample_frac, ground_truth_freq, constraints, use_val, val_frac, our_alg, data_path='../Data/', cons_obj_name=None, bound_check=False):
...
if __name__ == '__main__':
    ...
    true_err, estimate_err, not_bound_count = estimate_max_error(obj_name, base_name, test_date, ground_truth, predictions, sample_frac, ground_truth_freq, constraints, use_val, val_frac, our_alg, data_path, cons_obj_name)
